...
var M = {
    ...
    init: function () {
        ...
        //M.c.width = document.body.scrollWidth;
        //M.c.height = document.body.scrollHeight;
    ...
    draw: function () {
        ...
        // slow fade BG colour
        //M.ctx.shadowColor = 'rgba(0, 0, 0, 1)';
    ...
    createCode: function () {
        ...
        var randomInterval = M.randomFromInterval(2000, 10000);
    ...
    createCanvii: function (i) {
        ...
        for (var j = 1; j < codeLen; j++) {
            ...
            if (j < 5) {
                newCtx.shadowColor = 'hsl(163, 100%, 0%)';
                newCtx.fillStyle = 'hsla(163, 100%, 0%, ' + strength + ')';
            } else {
                fadeStrength = j / codeLen;
                fadeStrength = 1 - fadeStrength;

                newCtx.fillStyle = 'hsla(163, 100%, 0%, ' + (fadeStrength) + ')';
            }
    ...
    assignColumn: function () {
        var randomColumn = M.randomFromInterval(0, (M.COLUMNS - 1)),
            activeColumns = M.codes.filter(function(_){
                return _[0].open == false;
            });
    ...
    freeColumn: function(col) {
        M.codes[col][0].canvas = null;
        M.codes[col][0].open = true;
    },
